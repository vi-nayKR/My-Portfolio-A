  ...
  template: `
    <section id="projects" class="relative py-16 md:py-32 px-4 md:px-6 overflow-hidden">
      ...
      <div class="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <div class="relative z-10 flex flex-col lg:flex-row items-center gap-8 md:gap-12">
            <!-- Left side: details -->
            <div class="flex-1 min-w-0">
              <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <span class="text-xs font-mono text-accent bg-accent/10 px-2 py-1 rounded mb-2 inline-block">Featured Project</span>
                ...
                <a
                  ...
                  class="flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:border-accent/50 text-muted hover:text-frost text-sm transition-all duration-200 self-start sm:self-center"
                >
              ...
              <div class="space-y-4 mb-6 text-muted text-sm leading-relaxed max-w-2xl">
                <p>
                ...
                <p>
                  <strong class="text-frost">Architecture:</strong> Clean Architecture with isolated bounded contexts across four layers: Domain, Postgres Repository (pgx/PostGIS), Service, and Handler.
                </p>
                <p>
                  <strong class="text-frost">Core Systems:</strong> Real-time WebSocket chat (Redis Pub/Sub), spatial matchmaking (ST_DWithin), MinIO media proxying, and CI/CD deployment via Cloudflare Tunnel.
                </p>
              </div>
