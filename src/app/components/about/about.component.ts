        ...
        <div class="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div [class.animate-slide-in-left]="visible()" [style.opacity]="visible() ? '1' : '0'" style="transition: opacity 0.7s">
            ...
            <p class="text-muted leading-relaxed mb-6">
              Specializes in building scalable backends with <span class="text-frost">Go</span> and <span class="text-frost">Node.js</span>,
              and crafting interactive frontends with <span class="text-frost">Angular</span> and <span class="text-frost">React</span>.
